/*
  ...
  2. Create simplified policies that avoid circular dependencies
...
-- Drop existing policies for user_permissions and permissions
...
-- Create simplified policies for user_permissions (without recursion)
