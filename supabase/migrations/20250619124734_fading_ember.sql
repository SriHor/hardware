/*
  # Staff Management System with Designations

  1. New Tables
    - `designations` - Store different job designations/roles
    - Enhanced `users` table with designation_id reference
    - `role_permissions` - Define what each role can do
    - `user_permissions` - Individual user permissions (override role permissions)
