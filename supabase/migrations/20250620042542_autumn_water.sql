/*
  # Staff Management and Designations System
  ...
  3. Security
    ...
    - Admin-only access for designations and permissions management

  4. Functions
    - Permission checking and retrieval functions
    - User permission aggregation logic

  5. Default Data
    - Standard designations for hardware service business
...
CREATE TABLE IF NOT EXISTS designations (
  ...
  description text,
  department text,
  level integer DEFAULT 1, -- 1=junior, 2=senior, 3=manager, 4=executive
